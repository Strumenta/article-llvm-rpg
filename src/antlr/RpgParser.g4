...
csEVAL:
	...
	operationExtender=cs_operationExtender?
	target
	operator1=assignmentOperatorIncludingEqual
	fixedexpression=c_free
	(C_FREE_NEWLINE | EOF);
csEVAL_CORR:
...
dir_if:
	DIR_IF noot=DIR_NOT? DIR_DEFINED OPEN_PAREN copyText CLOSE_PAREN;
dir_elseif:
	DIR_ELSEIF noot=DIR_NOT? DIR_DEFINED OPEN_PAREN copyText CLOSE_PAREN;
dir_else: DIR_ELSE;
dir_endif: DIR_ENDIF;
...
pexpression:  OPEN_PAREN expression CLOSE_PAREN	;
